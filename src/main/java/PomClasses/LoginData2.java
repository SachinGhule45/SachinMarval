...
public class LoginData2 {
	...
	private WebElement agenext;

	@FindBy(xpath = "(//input[@type='radio'])[2]")
	private WebElement lastbtn;

	@FindBy(xpath = "//button[@class='travel_main_cta']")
	private WebElement savemed;

	@FindBy(xpath = "//label[@for='ped_no']")
	private WebElement Medno;

	// @FindBy(xpath="//button[@class='travel_main_cta']")private WebElement
	// medprod;

	public LoginData2(WebDriver driver) {
